          ...
          <Box className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <Box className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <Box className="flex gap-2">
                <span style={{ ...paragraphStyles }} className="font-semibold">
                  Color
                </span>
            ...
            <Box className="flex justify-between items-center" id="fdc">
              ...
              <Box className="flex justify-content-between" id="btns">
                <button
                  ...
                  className="flex ml-auto border-0 py-2 px-6 focus:outline-none hover:bg-[#3559E0] rounded-full mr-2 font-semibold"
                ...
                <button
                  ...
                  className="flex ml-auto border-[#3559E0] border-0 py-2 px-6 focus:outline-none rounded-full font-semibold"
