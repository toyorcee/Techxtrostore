...
const Header = () => {
  return (
    <header className="body-font shadow-lg bg-indigo-500/80">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        >
          ...
          <div className="grid">
            <span className="ml-3 text-2xl text-red">YS</span>
        ...
        <Link to={"/cart"}>
          <button className="inline-flex items-center text-white bg-indigo-500 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-700 rounded-full text-base mt-4 md:mt-0">
            Go to Cart
            <svg
              fill="none"
              stroke="currentColor"
