...
const Header = () => {
  return (
    <header className="body-font shadow-lg bg-[#9A031E]">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <Link to={"/cart"}>
          <button className="inline-flex items-center text-white bg-[#F05804] border-0 py-2 px-4 focus:outline-none rounded-full text-base mt-4 md:mt-0">
            Go to Cart
            <svg
              fill="none"
              stroke="currentColor"
